...
class HXCPP_CLASS_ATTRIBUTES FlxFilterFrames_obj : public  ::flixel::graphics::frames::FlxFramesCollection_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("FlxFilterFrames","\xf0","\xd8","\x17","\x11"); }
		...
		void addFilter( ::openfl::_legacy::filters::BitmapFilter filter);
		::Dynamic addFilter_dyn();

		void removeFilter( ::openfl::_legacy::filters::BitmapFilter filter);
		...
		void applyFilter( ::openfl::_legacy::filters::BitmapFilter filter);
