...
class FlxShapeType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("flixel.addons.display.shapes.FlxShapeType","\x30","\xc6","\x9e","\xb2"); }
		::String __ToString() const { return HX_HCSTRING("FlxShapeType.","\x45","\xe0","\x63","\x2f") + _hx_tag; }
