...
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_49_fullPath,"sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",49,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_65_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",65,0xcabeeced)
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_80_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",80,0xcabeeced)
namespace sys{
...
::String FileSystem_obj::fullPath(::String relPath){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_49_fullPath)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_65_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_80_deleteFile)
