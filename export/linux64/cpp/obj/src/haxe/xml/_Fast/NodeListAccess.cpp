...
HX_DEFINE_STACK_FRAME(_hx_pos_29ed76c59791b8f5_97_new,"haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","/usr/share/haxe/std/haxe/xml/Fast.hx",97,0xf81b771c)
HX_LOCAL_STACK_FRAME(_hx_pos_29ed76c59791b8f5_100_resolve,"haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","/usr/share/haxe/std/haxe/xml/Fast.hx",100,0xf81b771c)
namespace haxe{
namespace xml{
namespace _Fast{

void NodeListAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_29ed76c59791b8f5_97_new)
...
bool NodeListAccess_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::List NodeListAccess_obj::resolve(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_29ed76c59791b8f5_100_resolve)
