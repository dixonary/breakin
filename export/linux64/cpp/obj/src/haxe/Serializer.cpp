...
HX_DEFINE_STACK_FRAME(_hx_pos_55bb5de4e5373002_101_new,"haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/usr/share/haxe/std/haxe/Serializer.hx",101,0x6ee150de)
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_117_toString,"haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/usr/share/haxe/std/haxe/Serializer.hx",117,0x6ee150de)
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_153_serializeString,"haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/usr/share/haxe/std/haxe/Serializer.hx",153,0x6ee150de)
...
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_172_serializeRef,"haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/usr/share/haxe/std/haxe/Serializer.hx",172,0x6ee150de)
static const ::String _hx_array_data_6a6ea1fa_8[] = {
	HX_("r",72,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_209_serializeFields,"haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/usr/share/haxe/std/haxe/Serializer.hx",209,0x6ee150de)
static const ::String _hx_array_data_6a6ea1fa_11[] = {
	HX_("g",67,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_228_serialize,"haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/usr/share/haxe/std/haxe/Serializer.hx",228,0x6ee150de)
...
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_556_run,"haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/usr/share/haxe/std/haxe/Serializer.hx",556,0x6ee150de)
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_55_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/share/haxe/std/haxe/Serializer.hx",55,0x6ee150de)
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_67_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/share/haxe/std/haxe/Serializer.hx",67,0x6ee150de)
...
HX_LOCAL_STACK_FRAME(_hx_pos_55bb5de4e5373002_70_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/usr/share/haxe/std/haxe/Serializer.hx",70,0x6ee150de)
namespace haxe{

void Serializer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_55bb5de4e5373002_101_new)
...
::String Serializer_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_117_toString)
...
void Serializer_obj::serializeString(::String s){
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_153_serializeString)
...
bool Serializer_obj::serializeRef( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_172_serializeRef)
HXLINE( 176)		{
...
void Serializer_obj::serializeFields( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_209_serializeFields)
HXLINE( 210)		{
...
void Serializer_obj::serialize( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_228_serialize)
...
::String Serializer_obj::run( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_55bb5de4e5373002_556_run)
...
{
{
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_55_boot)
HXDLIN(  55)		USE_CACHE = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_67_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_55bb5de4e5373002_70_boot)
