...
HX_DEFINE_STACK_FRAME(_hx_pos_eb138af017b35b17_29_new,"haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","/usr/share/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",29,0xdb3f66f0)
HX_LOCAL_STACK_FRAME(_hx_pos_eb138af017b35b17_33_execute,"haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","/usr/share/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",33,0xdb3f66f0)
HX_LOCAL_STACK_FRAME(_hx_pos_eb138af017b35b17_37_setFlushMode,"haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","/usr/share/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",37,0xdb3f66f0)
HX_LOCAL_STACK_FRAME(_hx_pos_eb138af017b35b17_41_close,"haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","/usr/share/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",41,0xdb3f66f0)
HX_LOCAL_STACK_FRAME(_hx_pos_eb138af017b35b17_44_run,"haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","/usr/share/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",44,0xdb3f66f0)
namespace haxe{
namespace zip{

void Uncompress_obj::__construct( ::Dynamic windowBits){
            	HX_STACKFRAME(&_hx_pos_eb138af017b35b17_29_new)
...
bool Uncompress_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos, ::haxe::io::Bytes dst,int dstPos){
            	HX_STACKFRAME(&_hx_pos_eb138af017b35b17_33_execute)
...
void Uncompress_obj::setFlushMode( ::haxe::zip::FlushMode f){
            	HX_STACKFRAME(&_hx_pos_eb138af017b35b17_37_setFlushMode)
...
void Uncompress_obj::close(){
            	HX_STACKFRAME(&_hx_pos_eb138af017b35b17_41_close)
...
HX_DEFINE_DYNAMIC_FUNC0(Uncompress_obj,close,(void))
 ...
 ::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src, ::Dynamic bufsize){
            	HX_GC_STACKFRAME(&_hx_pos_eb138af017b35b17_44_run)
