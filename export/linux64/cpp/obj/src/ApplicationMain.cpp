...
HXLINE(  87)				if (!(::sys::FileSystem_obj::exists((::Sys_obj::getCwd() + HX_("/lime-legacy.ndll",32,ba,8e,27))))) {
HXLINE(  89)					::Sys_obj::setCwd(::haxe::io::Path_obj::directory(::Sys_obj::executablePath()));
            				}
            			}
            			catch( ::Dynamic _hx_e){
...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("HaxeFlixel",42,8f,0c,ac),HX_("breakin",64,6e,ce,e7),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)960,(int)960,(int)60,(int)0,((int)((int)((int)((int)((int)((int)((int)((int)((int)((int)::openfl::_legacy::Lib_obj::HARDWARE | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::RESIZABLE) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::VSYNC) | (int)(int)0) | (int)(int)0) | (int)(int)0),HX_("breakout",2f,bd,d6,ec),null(),null());
            	}
