...
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_97_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",97,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_98_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",98,0x9958eee3)
HX_LOCAL_STACK_FRAME(_hx_pos_559677d855d318da_99_boot,"flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",99,0x9958eee3)
...
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_97_boot)
HXDLIN(  97)		LEFT_STICK_CLICK = (int)9;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_98_boot)
HXDLIN(  98)		RIGHT_STICK_CLICK = (int)10;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_99_boot)
HXDLIN(  99)		GUIDE = (int)8;
            	}
{
