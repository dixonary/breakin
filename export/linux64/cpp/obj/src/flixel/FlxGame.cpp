...
HXLINE( 533)				 ::flixel::FlxGame _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 533)				_hx_tmp2->_accumulator = (_hx_tmp2->_accumulator + this->_elapsedMS);
HXLINE( 534)				Float _hx_tmp3;
HXDLIN( 534)				if ((this->_accumulator > this->_maxAccumulation)) {
HXLINE( 534)					_hx_tmp3 = this->_maxAccumulation;
            				}
            				else {
HXLINE( 534)					_hx_tmp3 = this->_accumulator;
            				}
HXDLIN( 534)				this->_accumulator = _hx_tmp3;
HXLINE( 536)				while((this->_accumulator >= this->_stepMS)){
HXLINE( 538)					this->step();
HXLINE( 539)					 ::flixel::FlxGame _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 539)					_hx_tmp4->_accumulator = (_hx_tmp4->_accumulator - this->_stepMS);
            				}
            			}
            			else {
