...
HX_DEFINE_STACK_FRAME(_hx_pos_7359b14db3bf483d_31_new,"cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","/usr/share/haxe/std/cpp/vm/Thread.hx",31,0x70514563)
HX_LOCAL_STACK_FRAME(_hx_pos_7359b14db3bf483d_38_sendMessage,"cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","/usr/share/haxe/std/cpp/vm/Thread.hx",38,0x70514563)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7359b14db3bf483d_46_current,"cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","/usr/share/haxe/std/cpp/vm/Thread.hx",46,0x70514563)
HX_LOCAL_STACK_FRAME(_hx_pos_7359b14db3bf483d_53_create,"cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","/usr/share/haxe/std/cpp/vm/Thread.hx",53,0x70514563)
HX_LOCAL_STACK_FRAME(_hx_pos_7359b14db3bf483d_62_readMessage,"cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","/usr/share/haxe/std/cpp/vm/Thread.hx",62,0x70514563)
namespace cpp{
namespace vm{

void Thread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_7359b14db3bf483d_31_new)
...
void Thread_obj::sendMessage( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_7359b14db3bf483d_38_sendMessage)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_7359b14db3bf483d_46_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_obj,current,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_GC_STACKFRAME(&_hx_pos_7359b14db3bf483d_53_create)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,create,return )
 ...
 ::Dynamic Thread_obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_7359b14db3bf483d_62_readMessage)
