...
HX_DEFINE_STACK_FRAME(_hx_pos_cdf54d8867c43815_20_new,"openfl._legacy.filters.DropShadowFilter","new",0x3d47a290,"openfl._legacy.filters.DropShadowFilter.new","openfl/_legacy/filters/DropShadowFilter.hx",20,0x00f971bd)
HX_LOCAL_STACK_FRAME(_hx_pos_cdf54d8867c43815_41_clone,"openfl._legacy.filters.DropShadowFilter","clone",0x8793d18d,"openfl._legacy.filters.DropShadowFilter.clone","openfl/_legacy/filters/DropShadowFilter.hx",41,0x00f971bd)
namespace openfl{
namespace _legacy{
namespace filters{
...
HXLINE(  22)		super::__construct(HX_("DropShadowFilter",a7,ee,49,f7));
HXLINE(  24)		this->distance = distance;
HXLINE(  25)		this->angle = angle;
HXLINE(  26)		this->color = color;
HXLINE(  27)		this->alpha = alpha;
HXLINE(  28)		this->blurX = blurX;
HXLINE(  29)		this->blurY = blurY;
HXLINE(  30)		this->strength = strength;
HXLINE(  31)		this->quality = quality;
HXLINE(  32)		this->inner = inner;
HXLINE(  33)		this->knockout = knockout;
HXLINE(  34)		this->hideObject = hideObject;
            	}
...
bool DropShadowFilter_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x21ceae8a) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x21ceae8a;
	} else {
 ...
 ::openfl::_legacy::filters::BitmapFilter DropShadowFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cdf54d8867c43815_41_clone)
HXDLIN(  41)		return  ::openfl::_legacy::filters::DropShadowFilter_obj::__alloc( HX_CTX ,this->distance,this->angle,this->color,this->alpha,this->blurX,this->blurY,this->strength,this->quality,this->inner,this->knockout,this->hideObject);
            	}
