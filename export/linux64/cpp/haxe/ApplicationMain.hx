...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "breakin", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "breakout", null, { width: 960, height: 960 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 960, height: 960 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 960, 960, "null");
		#end
		#else
		create ();
		#end
